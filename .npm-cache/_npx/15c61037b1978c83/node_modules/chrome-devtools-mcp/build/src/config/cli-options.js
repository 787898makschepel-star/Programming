...
export const commands = {
    ...
    evaluate_script: {
        description: 'Evaluate a JavaScript function inside the target page or service worker. Returns the response as JSON, so returned values have to be JSON-serializable.',
        category: 'Debugging',
        args: {
            pageId: {
                name: 'pageId',
                type: 'number',
                description: 'Targets a specific page by ID. Required when not evaluating in a service worker.',
                required: false,
            },
            function: {
                name: 'function',
            ...
            serviceWorkerId: {
                ...
                type: 'string',
                description: "The optional service worker id to evaluate the script in. If provided, 'pageId' should be omitted. Note: 'args' (element UIDs) cannot be used when evaluating in a service worker.",
                required: false,
            },
        },
    },
    ...
    get_heapsnapshot_edges: {
        ...
        args: {
            ...
            retainedSize: {
                name: 'retainedSize',
                type: 'string',
                description: 'Inclusive retained size range (e.g. "1MB-2MB", "-1MB", or "1MB-") for target nodes. A single value is treated as a minimum. Currently, only the lower bound is applied.',
                required: false,
            },
            excludePrimitives: {
    ...
    performance_start_trace: {
        ...
        args: {
            ...
            reload: {
                name: 'reload',
                type: 'boolean',
                description: 'Determines if, once tracing has started, the target page should be automatically reloaded. Navigate the page to the right URL using the navigate_page tool BEFORE starting the trace if reload or autoStop is set to true.',
                required: false,
                default: true,
            },
            autoStop: {
    ...
    query_heapsnapshot_objects: {
        ...
        args: {
            ...
            propertyName: {
                name: 'propertyName',
                type: 'string',
                description: 'Optional property name filter for outgoing reference edges.',
                required: false,
            },
            nodeType: {
                name: 'nodeType',
                type: 'string',
                description: 'Optional V8 node type filter (e.g. object, closure, string, array, code).',
                required: false,
            },
            retainedSize: {
                name: 'retainedSize',
                type: 'string',
                description: 'Inclusive retained size range (e.g. "1MB-2MB", "-1MB", or "1MB-"). A single value is treated as a minimum.',
                required: false,
            },
            selfSize: {
                name: 'selfSize',
                type: 'string',
                description: 'Inclusive self size range (e.g. "1MB-2MB", "-1MB", or "1MB-"). A single value is treated as a minimum.',
                required: false,
            },
            isDetached: {
                name: 'isDetached',
