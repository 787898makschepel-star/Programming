...
export class McpServer {
    ...
    async #getContext() {
        const chromeArgs = (this.#serverArgs.chromeArg ?? []).map(String);
        const ignoreDefaultChromeArgs = (this.#serverArgs.ignoreDefaultChromeArg ?? []).map(String);
    ...
    #registerTool(tool) {
        const toolHandler = new ToolHandler(tool, this.#serverArgs, () => this.#getContext(), this.#toolMutex);
