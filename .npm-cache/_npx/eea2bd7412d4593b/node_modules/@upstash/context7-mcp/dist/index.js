 ...
 */
function getClientContext(toolCtx) {
...
IMPORTANT: Do not call this tool more than 3 times per question. If you cannot find what you need after 3 calls, use the best result you have.`,
        inputSchema: z.preprocess(aliasArgs(GLOBAL_ALIASES), z.object({
            query: z
                .string()
    ...
    }, async ({ query, libraryName }, toolCtx) => {
...
Do not call this tool more than 3 times per question.`,
        inputSchema: z.preprocess(aliasArgs({ ...GLOBAL_ALIASES, ...QUERY_DOCS_ALIASES }), z.object({
            libraryId: z
                .string()
...
async function main() {
    ...
    if (TRANSPORT_TYPE === "http") {
        ...
        app.use((req, res, next) => {
            ...
            res.setHeader("Access-Control-Allow-Headers", "Content-Type, MCP-Session-Id, MCP-Protocol-Version, Mcp-Method, Mcp-Name, X-Context7-API-Key, Context7-API-Key, X-API-Key, Authorization");
