...
export class DeleteManyTool extends MongoDBToolBase {
    ...
    async execute({ connectionId, database, collection, filter, }) {
    ...
    getConfirmationMessage({ database, collection, filter }) {
        ...
        return (`You are about to delete documents from the **${escapeMarkdown(collection)}** collection in the **${escapeMarkdown(database)}** database:\n\n` +
            filterDescription +
