...
export class MongoDBToolBase extends ToolBase {
    ...
    async confirmWriteStages(targets, context) {
        ...
        throw new MongoDBError(ErrorCodes.ConfirmationDeclined, "User did not confirm the write stages of the aggregation pipeline so the aggregation was not performed.");
    }
