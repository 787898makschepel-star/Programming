...
export class ListCollectionsTool extends MongoDBToolBase {
    ...
    async execute({ connectionId, database }, { signal }) {
        ...
        return {
            content: formatUntrustedData(`Found ${collections.length} collections in the requested database.`, JSON.stringify({ database, collections })),
            structuredContent: {
                collections,
