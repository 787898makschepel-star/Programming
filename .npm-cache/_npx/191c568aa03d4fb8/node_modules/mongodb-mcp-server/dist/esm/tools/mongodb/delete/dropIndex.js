...
export class DropIndexTool extends MongoDBToolBase {
    ...
    getConfirmationMessage({ database, collection, indexName, type, }) {
        return (`You are about to drop the ${type === "search" ? "search index" : "index"} named **${escapeMarkdown(indexName)}** from the **${escapeMarkdown(database)}.${escapeMarkdown(collection)}** namespace:\n\n` +
