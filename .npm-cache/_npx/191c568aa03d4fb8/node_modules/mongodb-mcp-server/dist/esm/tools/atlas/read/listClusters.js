...
export class ListClustersTool extends AtlasToolBase {
    ...
    formatClustersTable(project, clusters, flexClusters) {
        ...
        return {
            content: formatUntrustedData(`Found ${allClusters.length} clusters in project ${project.id}:`, JSON.stringify({ projectName: project.name, clusters: allClusters })),
            structuredContent: {
                projectId: project.id,
                projectName: project.name,
