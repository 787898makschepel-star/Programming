...
export class RenameCollectionTool extends MongoDBToolBase {
    ...
    async execute({ connectionId, database, collection, newName, dropTarget, }) {
        if (dropTarget && this.config.disabledTools.includes("delete")) {
            ...
            throw new MongoDBError(ErrorCodes.ForbiddenWriteOperation, "When 'delete' operations are disabled, you can not rename a collection with 'dropTarget' set to true, as it would drop the target collection.");
        }
