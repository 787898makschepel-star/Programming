...
export class ToolBase {
    ...
    async invoke(args, context) {
         ...
         */
        const recordOutcome = (result, error) => {
        ...
        try {
            if (this.requiresConfirmation() &&
                ...
                const declined = { content: [{ type: "text", text }], isError: true };
     ...
     * user took to answer.
     */
    async requestConfirmation(message, context) {
        ...
        this.session.logger.info({
            ...
            attributes: {
                ...
                progressToken: context._meta?.progressToken !== undefined ? String(context._meta.progressToken) : "(undefined)",
     ...
     */
    elicitationRelatedRequestId(context) {
     ...
     */
    redirectToSharedShape(property, shape) {
    ...
    emitToolEvent(args, { startTime, result }) {
        ...
        void (async () => {
            ...
            this.session.logger.debug({
                ...
                context: "tool",
                message: `Error emitting telemetry event for tool ${this.name}: ${error}`,
            });
        });
    }
    ...
    getConnectionInfoMetadata(connectionState) {
        const metadata = {};
 ...
 */
ToolBase.sharedInputSchemas = new WeakMap();
ToolBase.sharedOutputSchemas = new WeakMap();
/**
