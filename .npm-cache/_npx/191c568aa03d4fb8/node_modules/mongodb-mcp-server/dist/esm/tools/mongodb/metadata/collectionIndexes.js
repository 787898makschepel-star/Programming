...
export class CollectionIndexesTool extends MongoDBToolBase {
    constructor() {
        ...
        this.argsShape = { ...ConnectionIdArgs, ...CollOperationArgs };
    ...
    async execute({ connectionId, database, collection, }) {
        ...
        return {
            content: [
                ...formatUntrustedData(`Found ${classicIndexes.length} classic indexes in the requested collection:`, JSON.stringify(classicIndexes)),
                ...(searchIndexes.length > 0
                    ? formatUntrustedData(`Found ${searchIndexes.length} search and vector search indexes in the requested collection:`, JSON.stringify(searchIndexes))
                    : []),
            ],
            structuredContent: {
                classicIndexes,
