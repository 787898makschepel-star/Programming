...
import type { CallToolResult, RequestId, ServerNotification, ServerRequest, ToolAnnotations } from "@modelcontextprotocol/sdk/types.js";
...
export declare abstract class ToolBase<TUserConfig extends UserConfig = UserConfig, TContext = unknown, TMetrics extends DefaultMetrics = DefaultMetrics> {
     ...
     */
    private static readonly sharedInputSchemas;
    private static readonly sharedOutputSchemas;
    /**
     ...
     */
    private resolveSharedInputSchema;
    /**
     ...
     */
    private resolveSharedOutputSchema;
