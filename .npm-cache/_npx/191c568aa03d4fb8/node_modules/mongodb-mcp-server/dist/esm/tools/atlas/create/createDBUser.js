...
export const CreateDBUserArgs = {
    ...
    roles: z
        ...
        roleName: z
            ...
            z
                .string()
                .regex(ALPHANUMERIC_DASH_UNDERSCORE_REGEX, "Custom role names can only contain letters, numbers, hyphens, and underscores"),
        ])
            .describe("Role name"),
...
export class CreateDBUserTool extends AtlasToolBase {
    constructor() {
        ...
        this.outputSchema = CreateDBUserOutputSchema;
    }
    async execute({ projectId, username, password, roles, clusters }, context) {
