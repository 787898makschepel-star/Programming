...
import { JSON_RPC_ERROR_CODE_SESSION_ID_REQUIRED, JSON_RPC_ERROR_CODE_SESSION_ID_INVALID, JSON_RPC_ERROR_CODE_INVALID_REQUEST, JSON_RPC_ERROR_CODE_SESSION_NOT_FOUND, JSON_RPC_ERROR_CODE_DISALLOWED_EXTERNAL_SESSION, JSON_RPC_ERROR_CODE_PROCESSING_REQUEST_FAILED, JSON_RPC_ERROR_CODE_SESSION_LIMIT_EXCEEDED, } from "./jsonRpcErrorCodes.js";
export class MCPHttpServer extends ExpressBasedHttpServer {
     ...
     */
    async restoreNegotiatedClientState(server, sessionId, headers) {
        let state;
        try {
     ...
     * after it.
     */
    captureNegotiatedClientStateOnInitialize(server, sessionId, headers) {
        const protocolServer = server.mcpServer.server;
        ...
        protocolServer.oninitialized = () => {
            ...
            this.sessionStore.saveNegotiatedClientState(sessionId, state, headers).catch((error) => {
                this.logger.warning({
