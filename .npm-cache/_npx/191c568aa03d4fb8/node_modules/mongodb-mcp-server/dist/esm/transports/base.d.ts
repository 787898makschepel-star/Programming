...
export declare abstract class TransportRunnerBase<TUserConfig extends UserConfig = UserConfig, TContext = unknown, TMetrics extends DefaultMetrics = DefaultMetrics> {
    ...
    protected constructor({ userConfig, connectionErrorHandler, createAtlasLocalClient, additionalLoggers, metrics, telemetryProperties, tools, createSessionConfig, createApiClient, }: TransportRunnerConfig<TUserConfig, TMetrics>);
