 ...
 */
export const ACCESS_LIST_ADDED_NOTE = "Note: Your current IP address has been added to the Atlas project's IP access list to enable secure connection.";
/**
 ...
 */
export const ACCESS_LIST_SKIPPED_NOTE = "No IP access list changes were made because this server cannot determine your public IP address. " +
 ...
 */
export const ACCESS_LIST_FAILED_NOTE = "No IP access list changes were made because the attempt to add your current IP address " +
 ...
 * can already connect).
 */
export function getAccessListNote(result) {
    switch (result) {
        case "added":
 ...
 */
export async function ensureCurrentIpInAccessList(apiClient, projectId, context) {
