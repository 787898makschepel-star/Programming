...
export async function getSuggestedIndexes(apiClient, projectId, clusterName, context) {
    try {
...
export async function getDropIndexSuggestions(apiClient, projectId, clusterName, context) {
    try {
...
export async function getSchemaAdvice(apiClient, projectId, clusterName, context) {
    try {
...
export async function getSlowQueries(apiClient, projectId, clusterName, since, namespaces, context) {
    try {
