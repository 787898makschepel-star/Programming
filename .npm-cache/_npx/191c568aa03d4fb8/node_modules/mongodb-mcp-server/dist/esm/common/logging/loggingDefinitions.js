...
export const LogId = {
    ...
    toolConfirmationRequested: mongoLogId(1003005),
    toolConfirmationSettled: mongoLogId(1003006),
    toolConfirmationStandaloneStreamFallback: mongoLogId(1003007),
    ...
    streamableHttpTransportSessionLimitExceeded: mongoLogId(1006012),
    streamableHttpTransportClientStateSaveFailure: mongoLogId(1006013),
    streamableHttpTransportClientStateRestoreFailure: mongoLogId(1006014),
    ...
    connectionRegistryRevoked: mongoLogId(1014001),
    connectionRegistryRevokeCallbackFailure: mongoLogId(1014002),
    connectionRegistryDialFailure: mongoLogId(1014003),
};
