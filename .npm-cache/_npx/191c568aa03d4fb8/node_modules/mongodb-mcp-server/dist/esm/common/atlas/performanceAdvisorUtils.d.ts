...
export declare function getSuggestedIndexes(apiClient: ApiClient, projectId: string, clusterName: string, context?: ApiClientRequestContext): Promise<{
    suggestedIndexes: Array<SuggestedIndex>;
}>;
export declare function getDropIndexSuggestions(apiClient: ApiClient, projectId: string, clusterName: string, context?: ApiClientRequestContext): Promise<{
    hiddenIndexes: Array<DropIndexSuggestion>;
    redundantIndexes: Array<DropIndexSuggestion>;
    unusedIndexes: Array<DropIndexSuggestion>;
}>;
export declare function getSchemaAdvice(apiClient: ApiClient, projectId: string, clusterName: string, context?: ApiClientRequestContext): Promise<{
    recommendations: Array<SchemaRecommendation>;
}>;
export declare function getSlowQueries(apiClient: ApiClient, projectId: string, clusterName: string, since?: Date, namespaces?: Array<string>, context?: ApiClientRequestContext): Promise<{
