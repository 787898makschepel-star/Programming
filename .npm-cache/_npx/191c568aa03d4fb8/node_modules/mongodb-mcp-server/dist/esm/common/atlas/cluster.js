...
export async function inspectCluster(apiClient, projectId, clusterName, context) {
    try {
...
export async function getProcessIdsFromCluster(apiClient, projectId, clusterName, context) {
    try {
