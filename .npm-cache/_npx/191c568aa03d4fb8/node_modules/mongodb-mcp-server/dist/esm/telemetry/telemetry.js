...
export class Telemetry {
    constructor(config) {
        ...
        this.eventCache = config.eventCache ?? new EventCache();
    ...
    async sendEvents(client, events, signal) {
        try {
            ...
            await client.sendEvents(events.map((event) => ({ ...event, properties: redact(event.properties, secrets) })), { signal: effectiveSignal });
