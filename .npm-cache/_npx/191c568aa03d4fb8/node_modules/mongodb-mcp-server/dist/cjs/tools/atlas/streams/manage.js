...
exports.StreamsManageTool = exports.ManageOutputSchema = void 0;
...
const ProcessorState = zod_1.z.enum(["STARTED", "STOPPED", "CREATED", "FAILED"]);
const ConnectionState = zod_1.z.enum(["PENDING", "READY", "DELETING", "FAILED"]);
const PeeringState = zod_1.z.enum(["ACCEPTED", "REJECTED"]);
exports.ManageOutputSchema = zod_1.z.object({
    ...
    region: zod_1.z.string().optional().describe("Confirmed workspace region after an update"),
    tier: zod_1.z.string().optional().describe("Confirmed workspace tier after an update"),
    maxTier: zod_1.z.string().optional().describe("Confirmed workspace max tier after an update"),
...
class StreamsManageTool extends streamsToolBase_js_1.StreamsToolBase {
    constructor() {
        ...
        this.argsShape = {
            ...
            resourceName: streamsArgs_js_1.StreamsArgs.resourceName()
                .optional()
            ...
            // peering options
            peeringId: streamsArgs_js_1.StreamsArgs.peeringId()
                .optional()
        ...
        this.outputSchema = exports.ManageOutputSchema.shape;
    }
    ...
    static mapUpdateWorkspaceStructuredContent(updated, options) {
    ...
    async startProcessor(args, context) {
        const name = this.requireResourceName(args.resourceName, "start-processor");
    ...
    async stopProcessor(args, context) {
        const name = this.requireResourceName(args.resourceName, "stop-processor");
        try {
            const processor = await this.apiClient.getStreamProcessor({
                params: { path: { groupId: args.projectId, tenantName: args.workspaceName, processorName: name } },
    ...
    async modifyProcessor(args, context) {
        const name = this.requireResourceName(args.resourceName, "modify-processor");
        const processor = await this.apiClient.getStreamProcessor({
            params: { path: { groupId: args.projectId, tenantName: args.workspaceName, processorName: name } },
        }, context);
    ...
    async updateWorkspace(args, context) {
        const body = {};
        if (args.newRegion) {
    ...
    async updateConnection(args, context) {
        const name = this.requireResourceName(args.resourceName, "update-connection");
        ...
        const structuredContent = parsedConnectionState.success
    ...
    async acceptPeering(args, context) {
        if (!args.peeringId)
    ...
    async rejectPeering(args, context) {
        if (!args.peeringId)
