...
class ExportTool extends mongodbTool_js_1.MongoDBToolBase {
    ...
    async execute({ connectionId, database, collection, jsonExportFormat, exportTitle, exportTarget: target, }, { signal }) {
...
ExportTool.toolName = constants_js_1.EXPORT_TOOL_NAME;
