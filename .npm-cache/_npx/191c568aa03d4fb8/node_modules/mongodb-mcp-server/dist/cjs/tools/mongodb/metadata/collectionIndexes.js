...
class CollectionIndexesTool extends mongodbTool_js_1.MongoDBToolBase {
    constructor() {
        ...
        this.argsShape = { ...mongodbTool_js_1.ConnectionIdArgs, ...mongodbTool_js_1.CollOperationArgs };
        this.outputSchema = CollectionIndexesOutputSchema;
    }
    async execute({ connectionId, database, collection, }) {
        ...
        return {
            content: [
                ...(0, tool_js_1.formatUntrustedData)(`Found ${classicIndexes.length} classic indexes in the requested collection:`, JSON.stringify(classicIndexes)),
                ...(searchIndexes.length > 0
                    ? (0, tool_js_1.formatUntrustedData)(`Found ${searchIndexes.length} search and vector search indexes in the requested collection:`, JSON.stringify(searchIndexes))
                    : []),
            ],
            structuredContent: {
                classicIndexes,
