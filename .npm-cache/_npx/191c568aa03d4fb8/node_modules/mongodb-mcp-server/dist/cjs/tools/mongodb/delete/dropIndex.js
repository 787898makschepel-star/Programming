...
const escapeMarkdown_js_1 = require("../../../helpers/escapeMarkdown.js");
...
class DropIndexTool extends mongodbTool_js_1.MongoDBToolBase {
    ...
    async dropSearchIndex(provider, { connectionId, database, collection, indexName }) {
    ...
    getConfirmationMessage({ database, collection, indexName, type, }) {
        return (`You are about to drop the ${type === "search" ? "search index" : "index"} named **${(0, escapeMarkdown_js_1.escapeMarkdown)(indexName)}** from the **${(0, escapeMarkdown_js_1.escapeMarkdown)(database)}.${(0, escapeMarkdown_js_1.escapeMarkdown)(collection)}** namespace:\n\n` +
