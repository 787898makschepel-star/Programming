...
const mongodb_schema_1 = require("@mongodb-js/mongodb-schema");
...
class CollectionSchemaTool extends mongodbTool_js_1.MongoDBToolBase {
    ...
    async execute({ connectionId, database, collection, sampleSize, responseBytesLimit }, { signal }) {
        ...
        return {
            content: (0, tool_js_1.formatUntrustedData)(header, JSON.stringify({ database, collection, schema })),
            structuredContent: {
                schema,
                fieldsCount,
            },
