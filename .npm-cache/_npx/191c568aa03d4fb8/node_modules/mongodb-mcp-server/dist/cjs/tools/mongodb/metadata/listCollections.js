...
class ListCollectionsTool extends mongodbTool_js_1.MongoDBToolBase {
    constructor() {
        ...
        this.argsShape = { ...mongodbTool_js_1.ConnectionIdArgs, ...mongodbTool_js_1.DBOperationArgs };
        this.outputSchema = ListCollectionsOutputSchema;
    }
    async execute({ connectionId, database }, { signal }) {
        ...
        return {
            content: (0, tool_js_1.formatUntrustedData)(`Found ${collections.length} collections in the requested database.`, JSON.stringify({ database, collections })),
            structuredContent: {
                collections,
