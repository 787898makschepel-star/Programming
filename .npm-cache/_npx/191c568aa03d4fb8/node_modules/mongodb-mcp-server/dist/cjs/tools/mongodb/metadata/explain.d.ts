...
export declare class ExplainTool extends MongoDBToolBase {
    ...
    protected execute({ connectionId, database, collection, method: methods, verbosity }: ToolArgs<typeof this.argsShape>, { signal }: ToolExecutionContext): Promise<ToolResult<typeof this.outputSchema>>;
}
export {};
