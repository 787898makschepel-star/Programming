...
export declare class ExportTool extends MongoDBToolBase {
    ...
    protected execute({ connectionId, database, collection, jsonExportFormat, exportTitle, exportTarget: target, }: ToolArgs<typeof this.argsShape>, { signal }: ToolExecutionContext): Promise<CallToolResult>;
