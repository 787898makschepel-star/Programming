...
exports.StreamsTeardownTool = exports.TeardownOutputSchema = void 0;
...
class StreamsTeardownTool extends streamsToolBase_js_1.StreamsToolBase {
    constructor() {
        ...
        this.argsShape = {
            ...
            resourceName: streamsArgs_js_1.StreamsArgs.resourceName().optional().describe("Name or ID of the specific resource to delete."),
        };
        this.outputSchema = exports.TeardownOutputSchema.shape;
    }
    ...
    async deleteProcessor(args, context) {
        const workspace = this.requireWorkspaceName(args);
        const name = this.requireResourceName(args);
        try {
    ...
    async deleteConnection(args, context) {
        const workspace = this.requireWorkspaceName(args);
        const name = this.requireResourceName(args);
    ...
    async deleteWorkspace(args, context) {
        const workspace = this.requireWorkspaceName(args);
        // Safety: summarize what will be deleted
        let impactNote = "";
        const structuredContent = { resource: "workspace" };
        try {
    ...
    async deletePrivateLink(args, context) {
    ...
    async deletePeering(args, context) {
        const id = this.requireResourceName(args);
