...
const CountOutputSchema = {
    count: zod_1.z.number().describe("The number of documents in the collection"),
};
class CountTool extends mongodbTool_js_1.MongoDBToolBase {
    constructor() {
        ...
        this.outputSchema = CountOutputSchema;
    }
    async execute({ connectionId, database, collection, query }, { signal }) {
