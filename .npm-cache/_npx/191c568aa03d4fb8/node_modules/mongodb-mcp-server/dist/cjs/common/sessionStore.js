...
exports.SessionStore = exports.SessionLimitExceededError = exports.SessionRejectedError = void 0;
...
exports.SessionRejectedError = SessionRejectedError;
/**
...
class SessionStore {
    constructor(params) {
        ...
        this.evictionIdleGraceMS = Math.min(options.evictionIdleGraceMS ?? 120000, this.idleTimeoutMS);
        this.logger = logger;
    ...
    async getSession(sessionId, _headers) {
    ...
    async addSession(params) {
        ...
        if (Object.keys(this.sessions).length >= this.maxSessions) {
            ...
            if (victimId === undefined) {
                this.logger.warning({
                    id: index_js_1.LogId.streamableHttpTransportSessionLimitExceeded,
                    context: "sessionStore",
    ...
    saveNegotiatedClientState(sessionId, state, headers) {
        return Promise.resolve();
    }
    loadNegotiatedClientState(sessionId, headers) {
