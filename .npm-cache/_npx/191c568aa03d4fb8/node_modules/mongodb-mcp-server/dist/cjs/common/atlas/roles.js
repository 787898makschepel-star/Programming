...
exports.BUILT_IN_DB_USER_ROLES = void 0;
exports.getDefaultRoleFromConfig = getDefaultRoleFromConfig;
/**
 ...
 */
exports.BUILT_IN_DB_USER_ROLES = [
    "atlasAdmin",
    "backup",
    "clusterMonitor",
    "dbAdmin",
 ...
 * https://www.mongodb.com/docs/atlas/mongodb-users-roles-and-privileges/
 */
function getDefaultRoleFromConfig(config) {
    if (config.readOnly) {
        return readOnlyRole;
    }
