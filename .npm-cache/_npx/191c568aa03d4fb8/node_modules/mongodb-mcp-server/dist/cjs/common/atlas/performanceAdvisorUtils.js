...
async function getSuggestedIndexes(apiClient, projectId, clusterName, context) {
    try {
...
async function getDropIndexSuggestions(apiClient, projectId, clusterName, context) {
    try {
...
async function getSchemaAdvice(apiClient, projectId, clusterName, context) {
    try {
...
async function getSlowQueries(apiClient, projectId, clusterName, since, namespaces, context) {
    try {
        const processIds = await (0, cluster_js_1.getProcessIdsFromCluster)(apiClient, projectId, clusterName, context);
