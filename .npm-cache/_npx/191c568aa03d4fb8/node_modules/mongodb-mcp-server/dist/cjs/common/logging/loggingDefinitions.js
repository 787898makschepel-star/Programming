...
exports.LogId = {
    ...
    toolConfirmationRequested: (0, mongodb_log_writer_1.mongoLogId)(1003005),
    toolConfirmationSettled: (0, mongodb_log_writer_1.mongoLogId)(1003006),
    toolConfirmationStandaloneStreamFallback: (0, mongodb_log_writer_1.mongoLogId)(1003007),
    ...
    streamableHttpTransportSessionLimitExceeded: (0, mongodb_log_writer_1.mongoLogId)(1006012),
    streamableHttpTransportClientStateSaveFailure: (0, mongodb_log_writer_1.mongoLogId)(1006013),
    streamableHttpTransportClientStateRestoreFailure: (0, mongodb_log_writer_1.mongoLogId)(1006014),
    ...
    connectionRegistryRevoked: (0, mongodb_log_writer_1.mongoLogId)(1014001),
    connectionRegistryRevokeCallbackFailure: (0, mongodb_log_writer_1.mongoLogId)(1014002),
    connectionRegistryDialFailure: (0, mongodb_log_writer_1.mongoLogId)(1014003),
};
