 ...
 */
function redactDriverOptions(driverOptions) {
...
class ConfigResource extends resource_js_1.ReactiveResource {
    ...
    toOutput() {
        const connectionInfo = (0, arg_parser_1.generateConnectionInfoFromCliArgs)(this.current);
        const result = {
        ...
        const secrets = [...this.session.keychain.allSecrets, ...keychain_js_1.Keychain.root.allSecrets];
        return JSON.stringify((0, keychain_js_1.redactValues)(result, secrets));
    }
    connectToolsGuidance() {
