...
class SSHAgent extends agent_base_1.Agent {
    ...
    createSshClient() {
        ...
        this.forwardOut = (0, util_1.promisify)(client.forwardOut.bind(client));
        return client;
    }
    async initialize(reinitializeClient = false) {
    ...
    async _connect(req, connectOpts, retriesLeft = 1) {
        ...
        try {
            ...
            const requiresNewClient = !initializedSuccessfully ||
                /Instance unusable after fatal error/.test(err.message);
            const retryableError = requiresNewClient ||
                /Not connected|Channel open failure|read ECONNRESET|Socket closed/.test(err.message);
